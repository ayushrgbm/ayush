  ...
  useEffect(() => {
    ...
    setTeamMembers([
      { 
        ...
        // bio: 'Alice is the visionary behind Parul Store, ensuring we always deliver quality products to our customers.',
  ...
  return (
    <div>
      ...
      <div className="my-10 flex flex-row justify-center gap-10 mb-28">
        ...
        <div className="flex flex-col justify-center items-start gap-6">
          ...
          <p className="text-gray-500">
            Parul Store, <br /> Waghodiya, Vadodara, Gujarat, India,391760.
          </p>
          <p className="text-gray-500">
            Tel: +91 79894091567 <br /> Email: ayushpatel9238@gmail.com
          </p>
          ...
          <p className="text-gray-500">
            ...
            parulstore.support@gmail.com
          </p>
          <p className="font-semibold text-xl text-gray-600">Careers at Parul Store</p>
      ...
      <div className="text-center my-20 px-10">
        ...
        <p className="text-gray-500">
          At Parul store, we strive to deliver the best quality products and a seamless shopping experience.
