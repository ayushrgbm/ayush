  ...
  const testimonials = [
    {
      ...
      text: "Parul Store is amazing! I found the perfect outfit for my special occasion, and the delivery was super fast.",
    },
    ...
    },
    {
      ...
      text: "Fast delivery and great prices! I’ve recommended Parul Store to all my friends.",
    },
    {
      name: "Sarah Wilson",
    ...
    <div>
      ...
      >
        ...
        <div className='flex flex-col justify-center gap-6 w-2/4 text-gray-600'>
          <p>Parul Store is a brand born out of a passion for fashion innovation. We focus on creating trendy, high-quality clothing for every occasion. Our journey started in 2025, and since then, we’ve been committed to offering the best shopping experience for our customers.</p>
      ...
      >
        <div>
          ...
          <p>At Parul Store, we believe in pushing boundaries and constantly innovating to bring you the latest fashion trends.</p>
        </div>
        <div>
